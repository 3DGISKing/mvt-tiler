...
export const vector_tile = $root.vector_tile = (() => {
    ...
    vector_tile.Tile = (function() {
        ...
        Tile.decode = function decode(reader, length, error) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.vector_tile.Tile();
        ...
        Tile.verify = function verify(message) {
            ...
            if (message.layers != null && message.hasOwnProperty("layers")) {
                ...
                for (let i = 0; i < message.layers.length; ++i) {
                    let error = $root.vector_tile.Tile.Layer.verify(message.layers[i]);
                    if (error)
                        return "layers." + error;
                }
            }
        ...
        Tile.fromObject = function fromObject(object) {
            if (object instanceof $root.vector_tile.Tile)
                return object;
            let message = new $root.vector_tile.Tile();
            if (object.layers) {
        ...
        Tile.Value = (function() {
            ...
            Value.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.vector_tile.Tile.Value();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Value.fromObject = function fromObject(object) {
                if (object instanceof $root.vector_tile.Tile.Value)
                    return object;
                let message = new $root.vector_tile.Tile.Value();
        ...
        Tile.Feature = (function() {
            ...
            Feature.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.vector_tile.Tile.Feature();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Feature.fromObject = function fromObject(object) {
                if (object instanceof $root.vector_tile.Tile.Feature)
                    return object;
                let message = new $root.vector_tile.Tile.Feature();
                if (object.id != null)
                    if ($util.Long)
        ...
        Tile.Layer = (function() {
            ...
            Layer.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.vector_tile.Tile.Layer();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Layer.verify = function verify(message) {
                ...
                if (message.features != null && message.hasOwnProperty("features")) {
                    ...
                    for (let i = 0; i < message.features.length; ++i) {
                        let error = $root.vector_tile.Tile.Feature.verify(message.features[i]);
                        if (error)
                ...
                if (message.values != null && message.hasOwnProperty("values")) {
                    ...
                    for (let i = 0; i < message.values.length; ++i) {
                        let error = $root.vector_tile.Tile.Value.verify(message.values[i]);
                        if (error)
                            return "values." + error;
                    }
                }
            ...
            Layer.fromObject = function fromObject(object) {
                if (object instanceof $root.vector_tile.Tile.Layer)
                    return object;
                let message = new $root.vector_tile.Tile.Layer();
